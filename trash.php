      ...
      <tbody>
        ...
        ?>
          <tr>
            ...
            <a href="restore.php?oUhTbAeCaNkXdKfNqMbEvVdUlZaQeRcGyIkLtCwUoLiLeXwOdDmTfRdCsMyDzLbLqFqDtVpPzRjCdBuBoDsReCpEtIqXePcPpReM=<?php echo $single_data['id'] ?>">Restore |</a>
            <a onclick="return confirm('Are You sure?');" href="delete.php?pIcOxHlOrEgUxKuKaIaNgYbZdWxObXqWoIpWnXyLxIvShQcKbSoHbSdUkXlIqWbEfTsFuZnQwChSwWaUoOkYtOoIzRkPiBbZjAbQ=<?php echo $single_data['id'] ?>">Permanent Delete</a>
          </td>
          </tr>
        <?php
        }
